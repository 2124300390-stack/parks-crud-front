...
function ParkCard({ park, onViewDetail, onEdit, onDelete }) {
  ...
  // Marcador de posición seguro en SVG para usar si todas las rutas de imagen fallan
  ...
  // Extrae el nombre del archivo de imagen
  let fileName = park.park_img_uri ? park.park_img_uri.split('/').pop().trim() : '';
  console.log('FileName: ' + fileName);

  // Lista indexada de intentos locales y de servidor
  const rutasAProbar = [];
